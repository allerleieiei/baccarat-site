...
const I18N = {
  ...
  ch: {
    ...
    heroText: (via) => `Werd Teil vo üüsere Community. Trag di ii, mir melded üüs schnäll und unkompliziert per ${via}.`,
    bullets: [
      { title: "Eifacher Start", text: "Schnäll aagmäldet – mir begleited di bim Iistieg." },
      { title: "Klare Resultat", text: "Regelmässigi Updates (5× i de Wuche)." },
      { title: "Community", text: "Profiitier vom Uustausch mit über 700 Lüüt." },
    ],
    form: {
      firstName: "Vorname",
      lastName: "Nachname",
      ...
      message: "Nachricht (optional)",
      submit: "Jetzt unverbindlich iitrage",
      age: (brand) => `Mit em Absände bestätigs, dass du mind. 18 bisch. ${brand} isch Unterhaltung, kei Anlage. Kei Gewinn‑Garantie. Bitte verantwortigsvoll mitmache.`,
      consent: (email) => ({
        label: "Ich bi iiverstande, dass mini Aagabe zur Kontaktufnahm gspeichert wärde.",
    ...
    thanks: {
      ...
      line: (via) => `Mir händ dini Aagabe erhalte und melded üüs bäld per ${via}.`,
      tip: "Tipp: Speicher üsi Nummer, das d'Nachricht aachocht.",
